...
setup(
    ...
    url="https://github.com/deadboizxc/monkey_pyrogram",  # Убедитесь, что у вас есть репозиторий по этому адресу
    download_url="https://github.com/deadboizxc/monkey_pyrogram/releases/latest",  # Обновите по мере появления релизов
    license="MIT",
    classifiers=[
    ...
    project_urls={
        "Tracker": "https://github.com/deadboizxc/monkey_pyrogram/issues",
        "Source": "https://github.com/deadboizxc/monkey_pyrogram",
        "Documentation": "https://github.com/deadboizxc/monkey_pyrogram/wiki",  # Если есть вики
    },
    python_requires=">=3.7",
    packages=find_packages(exclude=["tests*"]),
    package_data={
        "monkey_pyrogram": ["py.typed"],  # Если используется типизация
    },
    zip_safe=False,
